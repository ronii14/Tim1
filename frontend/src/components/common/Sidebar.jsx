...
import { Headphones, LayoutDashboard, Shirt, User, Shield, Key, Users, X, StretchHorizontal, ShoppingBag } from 'lucide-react';
...
const menuItems = [
  ...
  { label: 'Riwayat Transaksi',  icon: ShoppingBag,      to: '/admin/orders' },
